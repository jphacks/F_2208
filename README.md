...
# <br><br>⛩背景(製品開発のきっかけ、課題等） <br>
## これは『令和の貯金箱』

### 家族間のコミニュケーションの維持　×　一人暮らし生産性向上<br>
> ### 『最近忙しくて、まともに話してないなぁ…今、何してんだろう？』<br>『どうせ俺しかいないし、ゴミはその辺に置いとくか』
#### <br>そ ん な あ な た に

コロナ波が過ぎたかと思いきや、またコロナ、、、 。<br>
その変化に私たちは追われてしまい、家族間など、コミュニティ間で __①必要なコミニュケーション__ を取らなくなり、<br> __『あいつ何考えてんだ?』__ とストレスにつながる。<br>
特に家族間のストレスは、 __子どもの教育環境、働き世代の生産効率__ などさまざまな分野に影響を与えている。<br>

___生活が変わったのは、家族のみならず、 __単身世帯__ だって同じ。<br>特に、一人暮らしではやるべき課題に対して、<br> __『誰も見てないし、ま、いっかー』__ と、
なることが多い。<br>
 そんな中、__②『あれやりたい!』__ というモチベーションを維持するのはなかなか難しいと感じた。<br><br><br>
#### <br> "HAVE TO DO" を "WANT TO DO" に ！ <br>
そこで、私たちは、フレンド機能により、 __①Todoタスクを家族間で共有__ するというアプローチによって、家族間の __コミニュケーション__ を図ろうと考えた。<br>
...
## 最後に
細かい機能がたくさん詰まりつつも、UIやデザインにこだわりました。
#### 「な、なんだこいつは...、もはや、Todoアプリの域を超えているではないか…!!!」
と、思って頂ければ幸いだっぴ！　byミリック
